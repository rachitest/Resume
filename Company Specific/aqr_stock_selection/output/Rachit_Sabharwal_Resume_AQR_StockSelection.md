...
# Education
## **The University of Texas Health Science Center at Houston**, Biostatistics and Epidemiology
...
# Experience
## **The University of Texas Health Science Center at Houston**, Research Data Scientist
...
# Skills
**Machine Learning:** Cross-sectional & Time-Series Prediction, Multimodal Deep Learning, Graph Neural Networks, NLP, LLM Agentic Pipelines, Prompt Engineering, LLM APIs (Groq, Claude, Gemini, OpenAI-compatible), Bayesian Inference & Uncertainty Quantification, Explainable AI, Recommender Systems, Survival Analysis, Mixed Models

**ML/AI Libraries:** PyTorch, PyTorch Lightning, scikit-learn, Hugging Face, TensorFlow Probability, tidymodels, brms, Optuna
