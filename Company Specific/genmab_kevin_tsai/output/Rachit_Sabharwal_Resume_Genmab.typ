...
Ph.D. Candidate (expected Aug 2026) with 6+ years building biomedical AI systems and generating real-world evidence from EHR, clinical-trial, and population-cohort data across biopharma and academic-medical-center environments. Dissertation develops explainable multimodal AI for severe TBI outcome prediction, fusing imaging, physiologic, and structured EHR signals. Shipped production analytics and decision-support tools at Dow, Genentech, and BMS; track record of translating research into peer-reviewed publications and deployable systems.
...
#regular-entry(
  [
    ...
    - Developing an XAI multimodal biomedical AI model fusing heterogeneous clinical signals (imaging, physiologic, structured EHR) for TBI outcome prediction; benchmarked unimodal deep learning against classical-ML baselines across multiple biomedical data sources.

    - Designed the multi-site star schema and ETL for the R33 phase of DETECT-RPC, supervising 2 M.S. students while harmonizing clinical records from 6 academic medical centers (UCSF, UAB, UTSW, JHU, UTH, BCM).
    ...
    - Co-authored 4 peer-reviewed publications using survival analysis and linear mixed models on population-based cohorts (vaccine non-response, pediatric COVID comorbidities).
...
#regular-entry(
  [
    ...
    - Contributed to an internal Neo4j knowledge graph of drug-gene interactions used by R&D teams for therapeutic signature work.
...
#strong[Biomedical AI & Statistical Modeling:] Multimodal Deep Learning, Graph Neural Networks, Explainable AI, Bayesian Inference & UQ, Causal Inference, Survival Analysis, Mixed Models, Real-World Evidence, NLP, LLMs, Biomedical Data Integration
