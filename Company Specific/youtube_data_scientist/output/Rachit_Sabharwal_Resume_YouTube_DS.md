...
# Experience
## **UTHealth Houston, School of Public Health**, Research Data Scientist
...
Messiah SE, Abbas R, Bergqvist E, Swartz MD, Talebi Y, **Sabharwal R**, et al.
...
# Skills
**Causal Inference & Experimentation:** Difference-in-Differences, Synthetic Control, Propensity Scores / IPW, G-methods, Instrumental Variables, Target Trial Emulation, A/B Testing & Power Analysis

**Statistical Methods:** Survival Analysis, Linear & Generalized Linear Mixed Models, Longitudinal Data Analysis, Bayesian Inference & UQ, Measurement Error Modeling

**ML:** scikit-learn, PyTorch, tidymodels, brms, statsmodels, lifelines, Optuna, SHAP

**Programming & Data:** Python (polars, pandas, duckdb), R (data.table, tidyverse), SQL, SAS, Bash

**Production & Cloud:** Docker, Apache Airflow, GitHub/GitLab CI/CD, GCP (BigQuery), AWS, Azure, PostgreSQL

**Visualization & Communication:** R Shiny, Quarto, Tableau, ggplot2, Plotly, Streamlit, peer-reviewed publications, white papers
